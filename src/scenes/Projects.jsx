    ...
    <section id="projects" className="pt-32 pb-48">
      ...
      >
        ...
        <p className="mt-10 mb-10">
          Below are a few samples of projects that I have developed over the
          last 24 months. Each one is responsive in design and each project
          presented its own unique user interface challenges!
        </p>
      </motion.div>
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          {/* <Project subtitle="This is a test, only a test......" /> */}
